  ...
  const filtered = useMemo(
    () =>
      items.filter((payment) =>
        `${payment.rentalRequest?.property?.title || ""} ${payment.provider} ${payment.method || ""} ${payment.status} ${payment.transactionId || ""}`
          .toLowerCase()
        ...
        <div className="table-tools">
          <div className="search-box">
            ...
            <input
              ...
              placeholder="Search by property, provider or status..."
            />
          </div>
