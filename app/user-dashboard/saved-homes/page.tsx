    ...
    <div>
      ...
      {homes.length === 0 ? (
        <div className="panel review-empty">
          ...
          <p>Save a property from its details page and it will appear here.</p>
        ...
        <div className="saved-homes-grid">
          {homes.map((home, index) => (
            <article className="property-card saved-home-card" key={home.id}>
              <Link href={`/properties/${home.id}`}>
                <div
