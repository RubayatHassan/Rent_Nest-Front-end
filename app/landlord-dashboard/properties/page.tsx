...
export default function Page() {
  ...
  const [confirmingProperty, setConfirmingProperty] = useState<Property | null>(
    null,
  );
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : `Unable to ${editingId ? "update" : "create"} property`,
      );
    }
  };
  ...
  const remove = async (id: string) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Unable to remove property",
      );
    } finally {
      setRemovingId(null);
    }
  ...
  return (
    <div>
      ...
      {drawerOpen && (
        ...
        >
          <aside className="property-drawer panel">
      ...
      {confirmingProperty && (
        ...
        >
          ...
          >
            ...
            <p>
              <strong>{confirmingProperty.title}</strong> will be removed from
              your property list. You can’t undo this action.
            </p>
            <div className="confirmation-actions">
              ...
              <button
                ...
                disabled={removingId === confirmingProperty.id}
                onClick={() => remove(confirmingProperty.id)}
              >
                {removingId === confirmingProperty.id
                  ? "Removing…"
                  : "Yes, remove it"}
              </button>
            </div>
          ...
          <tbody>
            {items.map((property) => (
              <tr key={property.id}>
                ...
                <td>{money(property.rentAmount)}</td>
                <td>
                  <span
                ...
                <td>
                  ...
                  <button
                    type="button"
                    className="danger-button property-remove-button"
                    disabled={removingId === property.id}
                    onClick={() => setConfirmingProperty(property)}
                  >
