  ...
  return (
    <div>
      ...
      {drawerOpen && (
        ...
        >
          <aside className="property-drawer panel category-drawer">
            ...
            <div className="category-form-head">
              <div className="category-form-icon">⌂</div>
              <div>
                <p className="eyebrow">Organize your marketplace</p>
                <p className="drawer-description">
                  {editingId
                    ? "Update this category for your marketplace."
                    : "Add a clear category so renters can find the right property faster."}
                </p>
              </div>
            </div>
      ...
      <div className="panel table-panel category-list">
